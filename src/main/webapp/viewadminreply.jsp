...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div id="colOne">
            ...
            <form name="form1" method="post" action="viewadminreply.jsp" >
			<%    
    ...
    try
            {
                ...
                ResultSet rs = st.executeQuery("select user,complaintid,takeaction from takecomplaintaction where user='" + c1 + "'");
                while (rs.next()) {
                    a = rs.getString("user");
                    b = rs.getString("complaintid");
        ...
        %>   
              <table width="376" border="1">
                ...
                <tr>
                  <td>Complaintid</td>
                  <td><label>
                    <input type="text" name="complaintid" value='<%=b%>'/>
                  </label></td>
                </tr>
                <tr>
                  <td>Take Action </td>
