...
public final class LargeUpload_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  if (method.equalsIgnoreCase("head"))
  {
    ...
    if (filename!=null)
    {
 	...
 	if (account == null) account="";
         ...
         if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
         {
           ...
           if ( (files != null) && (!files.isEmpty()) )
           {
             UploadFile file = (UploadFile) files.get("uploadfile");
              if (file != null) out.println("<b> Successfully Uploaded the photo : "+file.getFileName());
      ...
      out.write("\r\n");
      out.write("</ul>\r\n");
      out.write("<form method=\"post\" action=\"LargeUpload.jsp\" name=\"upform\" enctype=\"multipart/form-data\">\r\n");
